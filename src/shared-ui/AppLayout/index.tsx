...
//     // Check if the current route is the space home page
//     if (isSpaceHome) {
//       return true;
//     }
//     const isPath = router.pathname.match(new RegExp(`^${getRoute}(\\/.*)?$`));

//     // Check if the current route matches the specific getRoute or its subpaths
//     if (isPath) {
//       return true;
//     }
...
//         mx="4"
//         borderRadius="lg"
//         color={isActive ? "primary" : "sage.500"}
//         role="group"
//         fontWeight={700}
//         cursor="pointer"
//         bg={isActive ? "sage.50" : "inherit"}
//         _hover={{
//           bg: "sage.50",
//           color: "primary",
//         }}
